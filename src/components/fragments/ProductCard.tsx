...
const Body = ({ children }: ProductCardProps) => (
  <>
...
const Footer = ({ children }: ProductCardProps) => (
...
const ProductCard = ({ children }: ProductCardProps) => {
  return (
    <div className="md:w-80 lg:w-80 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 my-5">
